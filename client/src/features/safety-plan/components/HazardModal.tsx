...
function getRiskColor(score: number) {
  if (score >= 12) return { bg: "bg-red-500", text: "text-white", label: "Extreme", ring: "ring-red-500/20" };
  if (score >= 8) return { bg: "bg-orange-500", text: "text-white", label: "High", ring: "ring-orange-500/20" };
  if (score >= 4) return { bg: "bg-amber-400", text: "text-amber-950", label: "Medium", ring: "ring-amber-400/20" };
  return { bg: "bg-emerald-500", text: "text-white", label: "Low", ring: "ring-emerald-500/20" };
}
