...
function getRiskColor(score: number) {
  if (score >= 12) return { bg: "bg-red-500", text: "text-white", border: "border-red-500/30" };
  if (score >= 8) return { bg: "bg-orange-500", text: "text-white", border: "border-orange-500/30" };
  if (score >= 4) return { bg: "bg-amber-400", text: "text-amber-900", border: "border-amber-400/30" };
  return { bg: "bg-primary", text: "text-primary-foreground", border: "border-primary/20" };
}
